...
INSERT INTO orders (id, user_id, price_order, quantity, destination_address, comment) VALUES (DEFAULT, 4, 150, 3, 'Кремлевская, 35', 'Буду на паре, оставьте на вахте!');
INSERT INTO orders (id, user_id, price_order, quantity, destination_address, comment, status) VALUES (DEFAULT, 4, 350, 1, 'Кремлевская, 35', 'Буду на паре, оставьте на вахте!', 'DELIVERED');
INSERT INTO orders (id, user_id, price_order, quantity, destination_address, comment, status) VALUES (DEFAULT, 4, 1300, 6, 'Кремлевская, 35', 'Буду на паре, оставьте на вахте!', 'PROCESSING');
INSERT INTO orders (id, user_id, price_order, quantity, destination_address, comment, status) VALUES (DEFAULT, 5, 1250, 3, 'Кремлевская, 35', 'Буду на паре, оставьте на вахте!', 'DELIVERED');
...
INSERT INTO orders (id, user_id, price_order, quantity, destination_address, comment, status) VALUES (DEFAULT, 3, 350, 1, 'Кремлевская, 35', 'Буду на паре, оставьте на вахте!', 'CANCELED');
INSERT INTO orders (id, user_id, price_order, quantity, destination_address, comment, status) VALUES (DEFAULT, 5, 350, 1, 'Кремлевская, 35', 'Буду на паре, оставьте на вахте!', 'DELIVERED');
INSERT INTO orders (id, user_id, price_order, quantity, destination_address, comment, status) VALUES (DEFAULT, 2, 450, 2, 'Кремлевская, 35', 'Буду на паре, оставьте на вахте!', 'CANCELED');
INSERT INTO orders (id, user_id, price_order, quantity, destination_address, comment, status) VALUES (DEFAULT, 5, 730, 1, 'Кремлевская, 35', 'Буду на паре, оставьте на вахте!', 'DELIVERED');
